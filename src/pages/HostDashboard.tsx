...
export function HostDashboard() {
  ...
  const session = getSession(gamePin); const [actionBusy, setActionBusy] = useState(false); const [stats, setStats] = useState<AnswerStats[]>([]); const [correctOption, setCorrectOption] = useState<number | null>(null); const [actionError, setActionError] = useState('')
